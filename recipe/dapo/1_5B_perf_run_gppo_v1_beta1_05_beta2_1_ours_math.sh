...
YOUR_MODEL_PATH="<your_model_path>" # Distill-1.5B path
...
ray job submit --no-wait --runtime-env="${RUNTIME_ENV}" \
    ...
    actor_rollout_ref.actor.loss_func="gppo_general" \
    actor_rollout_ref.actor.gppo_loss_beta1=0.5 \
    actor_rollout_ref.actor.gppo_loss_beta2=1.0 \
